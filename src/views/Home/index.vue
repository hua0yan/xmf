<template>
  <div class="home">
    ...
    <el-header>
      <el-button plain
        >工作台<i class="el-icon-close el-icon--right"></i
      ></el-button>
      <el-button plain>盘点单</el-button>
      <el-button plain
        >朴素按钮<i class="el-icon-close el-icon--right"></i
      ></el-button>
    </el-header>
    <!-- </el-container> -->
    <!-- 主体部分 -->
